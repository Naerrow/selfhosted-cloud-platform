...
| `threat-model.md` (예정) | Phase 0 (STRIDE v0) → Phase별 갱신 | STRIDE 기반 위협 모델, 신뢰 경계 정의 |
...
- 본 디렉터리 산출물은 외부 공개 추적 문서다 ([ADR-0009](../02-adr/0009-internal-only-design-docs.md) 정책 대상 아님).

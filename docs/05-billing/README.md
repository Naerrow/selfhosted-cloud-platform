...
핵심 결정은 [ADR-0008](../02-adr/0008-phase3-billing-scope.md) (스코프 — 종량제 단일 모델) + [ADR-0006](../02-adr/0006-billing-integrity-mechanism.md) (무결성 메커니즘, Proposed). 전체 단계 정의는 [`../../ROADMAP.md`](../../ROADMAP.md) Phase 1·3·7 참조.
